...
LOGIN_URL = 'login'  # Matches your custom login URL name
LOGIN_REDIRECT_URL = 'index'  # Redirects to homepage after login
LOGOUT_REDIRECT_URL = 'index'  # Redirects to homepage after logout

# Session Settings (for cart persistence)
SESSION_COOKIE_AGE = 86400  # 1 day in seconds (optional)
